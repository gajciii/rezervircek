        ...
        <tbody>
            <?php foreach ($results as $row): ?>
                <tr>
                    ...
                    <td>
                        <!-- Include restavracija_id as a query parameter in the link -->
                        <a href="rezervacija.php?restavracija_id=<?php echo $row['restavracija_id']; ?>" class="btn btn-primary">Rezerviraj</a>
